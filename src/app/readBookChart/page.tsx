...
const ReadBooks = () => {
    ...
    return (
        <div className='pt-20 container mx-auto space-y-7 flex justify-center'>
{
    readBooks.length > 0 ?(            <BarChart
      ...
      >
        ...
        <div className=" mt-20 flex items-center min-h-[220px] flex-col items-center justify-center rounded-2xl border border-dashed border-gray-300 bg-gradient-to-br from-blue-50 via-white to-purple-50 px-6 py-10 text-center">
        ...
        <p className="mt-2 max-w-md text-sm leading-6 text-gray-500">
          ...
          Start reading your favorite books and they will appear here.
        </p>
